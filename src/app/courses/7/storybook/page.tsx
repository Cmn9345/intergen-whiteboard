    ...
    <main className="min-h-screen bg-black relative">
      ...
      <div className="fixed top-4 left-4 z-50">
        <button
          ...
          title={`返回${getWeekTitle('7')}課程`}
        >
          <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
          </svg>
          <span className="text-sm font-medium text-gray-700">返回{getWeekTitle('7')}</span>
        </button>
      </div>
      ...
      <div className="w-full h-screen flex items-center justify-center">
        <div className="w-full h-full max-w-none">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/JLawbDGrn_Y?autoplay=1&rel=0&modestbranding=1&showinfo=0&start=141"
            title="我的阿公阿嬤同學 - 繪本故事"
            frameBorder="0"
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black bg-opacity-75 text-white p-4 z-40">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold">《我的阿公阿嬤同學》</h2>
