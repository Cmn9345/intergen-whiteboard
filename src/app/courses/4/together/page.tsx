  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "var(--space-xl)" }}>
        ...
        <p style={{ color: "var(--color-text-secondary)", fontSize: "var(--font-size-xl)", marginTop: "var(--space-xs)" }}>健康歌，跟著一起動起來！</p>
      </div>
      ...
      <div style={{
        ...
        <iframe
          src="https://www.youtube.com/embed/21u1_SRIkyI?feature=oembed"
          frameBorder="0"
      ...
      <FloatingNav prev={{ href: "/courses/4", label: "回課程" }} next={{ href: "/courses/4/toy-sharing", label: "玩具分享" }} />
    </div>
  );
}
