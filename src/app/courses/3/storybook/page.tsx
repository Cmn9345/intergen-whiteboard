    ...
    <main className="min-h-screen bg-black relative">
      ...
      <div className="w-full h-screen flex items-center justify-center">
        <div className="w-full h-full max-w-none">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/EVFPL_qXChU?autoplay=1&rel=0&modestbranding=1&showinfo=0"
            title="長大後你想做什麼工作? - 繪本故事"
            frameBorder="0"
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black bg-opacity-75 text-white p-4 z-40">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold">《長大後你想做什麼工作?》</h2>
