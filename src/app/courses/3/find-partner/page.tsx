...
// This is identical to courses/1/find-partner/page.tsx
// usePathname detects /courses/1 vs /courses/3 for back link
...
export default function FindPartnerPage() {
  ...
  const weekNum = weekMatch ? parseInt(weekMatch[1]) : 3;
