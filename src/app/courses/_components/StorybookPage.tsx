...
const storybookData: Record<number, StorybookData> = {
  ...
  6: { title: "數腳腳", desc: "一起來認識動物的腳", type: "local", videoSrc: "https://pub-60ae6880dce94b528a9a0cebba71fe80.r2.dev/videos/%E5%8B%95%E7%89%A9%E5%A4%A7%E8%B6%B4%E8%B8%A2.mov", discussion: ["你認識哪些動物的腳？", "為什麼有些動物是 2 隻腳，有些是 4 隻腳？", "你有看過什麼特別的動物嗎？", "如果你是一種動物，你想當什麼？"] },
